...
namespace UserService.JWT
{
    public class JwtAuthManager
    {
        ...
        public JwtAuthResult GenerateTokens(string username, Claim[] claims, DateTime now)
        {
            ...
            JwtAuthResult jwtAuthResult = new JwtAuthResult { AccessToken = accessToken, RefreshToken = refreshToken };
        ...
        public JwtAuthResult Refresh(string refreshToken, string accessToken, DateTime now)
        {
            ...
            JwtAuthResult jwtAuthResult = GenerateTokens(userName, principal.Claims.ToArray(), now); // need to recover the original claims
            return jwtAuthResult;
        }
